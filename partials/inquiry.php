...
<body>
                ...
                <div class=" row">
                    ...
                    <div class="col-xl-auto ms-xl-auto header-top-right align-self text-center text-xl-end">
                        ...
                        <div class="element pt-0 pt-lg-10 pb-10 ">
                            <a type="button" href="/form.php" class="btn btn-warning"
                                style="font-weight: 700;">Admission
                                Enquiry</a>
    ...
    <section class="page-title layer-overlay overlay-dark-9 section-typo-light bg-img-center" "
        style=" background: linear-gradient(125deg, #9700a7, #020079);">
        ...
        <section>
            <div class="container">
                <div class="row tm-blog-sidebar-row">
                    <div class="col-md-12 card" style="margin-top: 30px;">

                        <h1 class="text-center  text-uppercase"
                            style="color: rgb(33, 150, 0); font-weight: 700; margin-top: 40px;">Thank
                            You
                            For the Enquiry!</h1>
                        <h3 class="text-center text-dark">You are all set.</h3>
                        <p class="text-center text-dark">Please click.</p>
                        <a href="/diet-brochure.pdf"
                            class="btn btn-theme-colored1 align-self-center text-white text-center btn-block"
                            style="border-radius: 10px; background-color: #9700a7; margin-bottom: 10px;">Download
                            Brochure</a>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    <div class="col-md-6 col-lg-6 col-xl-3">
                        ...
                        <ul class="styled-icons icon-dark icon-theme-colored1 icon-rounded clearfix">
                            ...
                            <li><a class="social-link" href="https://www.instagram.com/dnyanshree_institute/?hl=en"><i
